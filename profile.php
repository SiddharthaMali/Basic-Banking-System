...
if (isset($_POST['submit'])){
   ...
   $sql = "UPDATE users SET amount=amount-$amount WHERE username='$sender'";
   $stmt= $pdo->prepare($sql);
   $stmt->execute();

   $sql = "UPDATE users SET amount=amount+$amount WHERE username='$receiver'";
   $stmt= $pdo->prepare($sql);
   $stmt->execute();
 ?>
 <script>
                           ...
                           <hr style="border:1px solid white;">
                                <div class="panel panel-default" style="color:  black;" >
                                   <div class="panel-body">
                                      <p><b>Name:</b> <?php echo htmlentities($row['username']); ?></p>
