...
.container-fluid{
    ...
    background-image: url('1ea2bf43d262adc533f6ba78a7772a9c.jpg');
                    ...
                    <div class="table-responsive tb">
                        <table class="table table-striped">
                            ...
                            if(count($rows)>0){
                                ...
                                <td style="text-tranform: uppercase; text-decoration: none;"><?php echo('<a href="profile.php?user_id='.$row['id'].'">'.htmlentities($row['username']).'</a> ');
                                                ?>  </td>
